...
namespace Site.Areas.Identity.Pages.Account.Manage
{
    public class EnableAuthenticatorModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            _logger.LogInformation("L'utilisateur avec l'ID '{UserId}' a activé la double authentification avec une application de double authentification.", userId);

            StatusMessage = "Votre application de double authentification a été vérifiée.";
