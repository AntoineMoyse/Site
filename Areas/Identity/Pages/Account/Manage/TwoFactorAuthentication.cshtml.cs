...
namespace Site.Areas.Identity.Pages.Account.Manage
{
    public class TwoFactorAuthenticationModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPost()
        {
            ...
            StatusMessage = "Le navigateur actuel a été oublié. Quand vous vous connecterez à nouveau à partir de ce navigateur, saisissez votre code de double authentification.";
