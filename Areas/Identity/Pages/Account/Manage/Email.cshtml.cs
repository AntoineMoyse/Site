...
namespace Site.Areas.Identity.Pages.Account.Manage
{
    public partial class EmailModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostChangeEmailAsync()
        {
            ...
            if (Input.NewEmail != email)
            {
                ...
                await _emailSender.SendEmailAsync(
                    Input.NewEmail,
                    "Confirmer changement adresse mail",
                    @$"<div>Bonjour !</div>
                    <div>Une demande de changement d'adresse mail à été faite pour votre compte Mon Site</div>
                    <div>Pour finaliser ce changement de mail <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>cliquez ici</a>.</div>
                    <div></div>
                    <div>A bientôt !</div>
                ...
                StatusMessage = "Lien de confirmation pour le changement d'adresse mail envoyé. Vérifiez vos mails.";
        ...
        public async Task<IActionResult> OnPostSendVerificationEmailAsync()
        {
            ...
            StatusMessage = "L'email de vérification envoyé. Mervi de bien vérifier votre boîte mail.";
            return RedirectToPage();
        }
    }
}
